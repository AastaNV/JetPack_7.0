...
sudo apt-get install -y libtbbmalloc2 libtbb-dev libjpeg-dev libpng-dev libtiff-dev libv4l-dev v4l-utils qv4l2
...
# apply patch for CUDA 13
cd opencv_contrib-${version}/
wget https://raw.githubusercontent.com/AastaNV/JetPack_7.0/refs/heads/main/patch/opencv_contrib_4.12.0_cuda13.patch
git apply opencv_contrib_4.12.0_cuda13.patch
cd ../opencv-${version}/
wget https://raw.githubusercontent.com/AastaNV/JetPack_7.0/refs/heads/main/patch/opencv_4.12.0_cuda13.patch
git apply opencv_4.12.0_cuda13.patch
